...
public final class FragmentLibraryBinding implements ViewBinding {
  ...
  private FragmentLibraryBinding(@NonNull FrameLayout rootView, @NonNull ImageView myImageView) {
  ...
  public static FragmentLibraryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentLibraryBinding((FrameLayout) rootView, myImageView);
    }
